---
title: "NBN EN 1992-1-1:2004 — Armatures"
type: norm-extract
source: "NBN EN 1992-1-1:2004"
norm: EC2
section: "C"
chapter: "Armatures"
tags: [EC2, eurocode-2, armatures]
related: ["[[EC2_index]]", "[[EC2_B_fluage-retrait.md]]", "[[EC2_D_relaxation.md]]", "[[_Knowledge — Index]]"]
created: 2026-06-06
---
...
## (1)P Limite d'élasticité maximale

La limite d'élasticité maximale réelle $f_{y,\text{max}}$ **ne doit pas dépasser** $1,3 f_{yk}$.

---

## Considérations

Cette clause garantit que les armatures ne présentent pas un comportement trop fragile et que la capacité de déformation plastique est suffisante pour les calculs aux états-limites ultimes.

Le rapport $f_{y,\text{max}} / f_{yk}$ est limité pour :
- Assurer une ductilité minimale
- Permettre une redistribution des efforts dans les structures hyperstatics
- Éviter un comportement fragile des armatures

---

## Voir aussi

- [[EC2_C.1_proprietes-armatures.md|C.1]] — Propriétés des armatures (valeurs caractéristiques)
- [[EC2_C.3_pliage.md|C.3]] — Aptitude au pliage
- [[EC2_3.2_acier-armatures.md|3.2]] — Propriétés de l'acier des armatures

# C.3 Aptitude au pliage

## (1)P Vérification par essais de pliage-dépliage

L'aptitude au pliage doit être vérifiée par des **essais de pliage-dépliage** conformément à :
- **EN 10080** — Acier pour l'armature du béton
- **EN ISO 15630-1** — Aciers et produits métalliques — Essais de propriétés mécaniques — Armatures de béton armé

### Procédure d'essai avec dépliage seul

Lorsque la vérification est effectuée **uniquement par un essai de dépliage**, la taille du mandrin **ne doit pas être supérieure** à celle spécifiée pour le pliage dans le [[EC2_8.1_armatures.md|Tableau 8.1]] du présent Eurocode.

### Critère de conformité

Pour que l'aptitude au pliage soit assurée, **aucune fissure visible** ne doit apparaître après le **premier pliage**.

---

## Justification

L'essai de pliage-dépliage évalue la ductilité et la résistance à la fissuration des armatures en conditions de déformation importante. C'est un essai de routine de contrôle de qualité qui garantit :
- Une déformation plastique suffisante
- L'absence de fragilité ou de défauts internes
- La conformité aux niveaux de classe (A, B, C) définis en [[EC2_C.1_proprietes-armatures.md|C.1]]

---

## Voir aussi

- [[EC2_C.1_proprietes-armatures.md|C.1]] — Généralités et propriétés des armatures
- [[EC2_C.2_resistance.md|C.2]] — Résistance (limite d'élasticité maximale)
- [[EC2_8.1_armatures.md|8.1]] — Tableau des diamètres de mandrin pour pliage
- [[EC2_8.8_ancrage.md|8.8]] — Ancrage des armatures longitudinales

---

Liens : [[EC2_index]] · [[EC2_B_fluage-retrait.md]] · [[EC2_D_relaxation.md]] · [[_Knowledge — Index]] · [[CLAUDE]]
